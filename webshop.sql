...
CREATE EVENT `Wipe` ON SCHEDULE EVERY 1 DAY 
STARTS '2022-04-12 00:00:00.000000' 
ENDS '2022-04-12 00:01:00.000000' ON COMPLETION PRESERVE ENABLE 
COMMENT 'Töröl adatot kosárból 24 óránként' 
DO DELETE FROM kosar;